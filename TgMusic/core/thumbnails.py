...
def resize_jiosaavn_thumbnail(img: Image.Image) -> Image.Image:
    return resize_youtube_thumbnail(img)
...
async def fetch_image(url: str) -> Image.Image | None:
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            elif url.startswith("http://c.saavncdn.com") or url.startswith("https://c.saavncdn.com"):
                url = (
                    url.replace("150x150", "500x500")
                    .replace("50x50", "500x500")
                    .replace("75x75", "500x500")
            ...
            if url.startswith("https://i.ytimg.com"):
                ...
                url.startswith("http://c.saavncdn.com")
                or url.startswith("https://c.saavncdn.com")
                or url.startswith("https://i1.sndcdn")
            ):
